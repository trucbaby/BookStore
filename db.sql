use master
IF exists(select * from sysdatabases where name='LAB1_QLSACH')
	drop database LAB1_QLSACH
go
create database LAB1_QLSACH
go
use LAB1_QLSACH
...
(
	...
	Dienthoainhan varchar(10),
	HTThanhtian BIT Default 0,
